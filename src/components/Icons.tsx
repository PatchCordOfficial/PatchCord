...
export function ShareIcon(props: IconProps) {
    return (
        ...
        >
            <path
                fill={props.fill || "currentColor"}
                d="M12 3a1 1 0 0 1 .7.29l4 4a1 1 0 0 1-1.4 1.42L13 6.41V15a1 1 0 1 1-2 0V6.41L8.7 8.71a1 1 0 1 1-1.4-1.42l4-4A1 1 0 0 1 12 3Z"
            />
            <path
                fill={props.fill || "currentColor"}
...
export function CommunityIcon(props: IconProps) {
    return (
        ...
        >
            ...
            <path
                fill={props.fill || "currentColor"}
                d="M11 14C7.13401 14 4 16.4624 4 19.5C4 19.7761 4.22386 20 4.5 20H17.5C17.7761 20 18 19.7761 18 19.5C18 16.4624 14.866 14 11 14Z"
            />
            <path
                fill={props.fill || "currentColor"}
                d="M17.2929 4.29289C17.6834 3.90237 18.3166 3.90237 18.7071 4.29289L20.7071 6.29289C21.0976 6.68342 21.0976 7.31658 20.7071 7.70711L18.7071 9.70711C18.3166 10.0976 17.6834 10.0976 17.2929 9.70711C16.9024 9.31658 16.9024 8.68342 17.2929 8.29289L17.5858 8H15C14.4477 8 14 7.55228 14 7C14 6.44772 14.4477 6 15 6H17.5858L17.2929 5.70711C16.9024 5.31658 16.9024 4.68342 17.2929 4.29289Z"
            />
            <path
                fill={props.fill || "currentColor"}
                d="M19.5 12C20.8807 12 22 13.1193 22 14.5V17.5C22 18.8807 20.8807 20 19.5 20H19.4C19.4 17.3216 18.0221 15.0966 15.9736 13.6767C16.9615 12.6427 18.1857 12 19.5 12Z"
            />
        </Icon>
    );
}
...
export function PatchCordIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            viewBox="0 0 24 24"
...
export function BadgeIcon(props: IconProps) {
    return (
        ...
        >
            <path
                fill={props.fill || "currentColor"}
                d="M12 2a7 7 0 0 0-7 7c0 4.5 3.1 8.2 7 11 3.9-2.8 7-6.5 7-11a7 7 0 0 0-7-7Zm0 2a5 5 0 0 1 5 5c0 3.2-2.1 5.9-5 8.2-2.9-2.3-5-5-5-8.2a5 5 0 0 1 5-5Zm.5 2.5h-1v3.2l2.4 1.4.6-1-2-1.2V6.5Zm-2 7.5h4v1.5h-4V12Z"
            />
        </Icon>
    );
}
