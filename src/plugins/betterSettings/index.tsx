...
import { AchievementsIcon, AppsIcon, CreditCardIcon, GameControllerIcon, HammerAndChiselIcon, MainSettingsIcon, PatchCordIcon, PencilSparkleIcon, UserIcon } from "@components/Icons";
...
const SECTION_ICONS: Record<string, Icon> = {
    ...
    equicord_section: PatchCordIcon,
