...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        ...
        { src: "https://patchcord.itssolar.dev/assets/favicon.png", shown: settings.store.showEquicordContributor, title: "Equicord contributor badge", key: "EquicordContributer", position: settings.store.EquicordContributorPosition },
        { src: PC_ICON_DATA_URL, shown: settings.store.showVencordDonor, title: "Vencord donor badges", key: "VencordDonor", position: settings.store.VencordDonorPosition },
